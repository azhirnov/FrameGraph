...
*/
	void FGShadertoyApp::_InitSamples ()
	{
		...
		{
			ShaderDescr	sh_main;
			sh_main.Pipeline( R"#(C:\Projects\VkFrameGraph\samples\framegraph\Shadertoy\st_shaders\OceanPlanet.glsl)#" );
		...
		{
			ShaderDescr	sh_bufA;
			sh_bufA.Pipeline( R"#(C:\Projects\VkFrameGraph\samples\framegraph\Shadertoy\st_shaders\FinalCS-Barboy-Opt1.glsl)#" );
			CHECK( _AddShader( "bufA", std::move(sh_bufA) ));

			ShaderDescr	sh_main;
			sh_main.Pipeline( R"#(C:\Projects\VkFrameGraph\samples\framegraph\Shadertoy\st_shaders\FinalCS-Barboy-Opt2.glsl)#" );
		...
		{
			ShaderDescr	sh_main;
			sh_main.Pipeline( R"#(C:\Projects\VkFrameGraph\samples\framegraph\Shadertoy\st_shaders\FinalCS-Barboy.glsl)#" );
			CHECK( _AddShader( "main", std::move(sh_main) ));
		});*/
		...
		{
			ShaderDescr	sh_main;
			sh_main.Pipeline( R"#(C:\Projects\VkFrameGraph\samples\framegraph\Shadertoy\st_shaders\Glowballs.glsl)#" );
		...
		{
			ShaderDescr	sh_bufA;
			sh_bufA.Pipeline( R"#(C:\Projects\VkFrameGraph\samples\framegraph\Shadertoy\st_shaders\SkylineOpt1.glsl)#" );
			CHECK( _AddShader( "bufA", std::move(sh_bufA) ));

			ShaderDescr	sh_main;
			sh_main.Pipeline( R"#(C:\Projects\VkFrameGraph\samples\framegraph\Shadertoy\st_shaders\SkylineOpt2.glsl)#" );
			sh_main.InChannel( "bufA", 0 );
			CHECK( _AddShader( "main", std::move(sh_main) ));
		});*/
		/*
		...
		{
			ShaderDescr	sh_main;
			sh_main.Pipeline( R"(C:\Projects\VkFrameGraph\samples\framegraph\Shadertoy\st_shaders\Skyline2.glsl)" );
			CHECK( _AddShader( "main", std::move(sh_main) ));
		});*/
		...
		_samples.push_back( [this] ()
		{
			...
			sh_bufA.Pipeline( R"#(C:\Projects\VkFrameGraph\samples\framegraph\Shadertoy\st_shaders\Skyline3-1.glsl)#" );
			CHECK( _AddShader( "bufA", std::move(sh_bufA) ));

			ShaderDescr	sh_main;
			sh_main.Pipeline( R"#(C:\Projects\VkFrameGraph\samples\framegraph\Shadertoy\st_shaders\Skyline3-2.glsl)#" );
			sh_main.InChannel( "bufA", 0 );
			CHECK( _AddShader( "main", std::move(sh_main) ));
		});
		...
		{
			ShaderDescr	sh_main;
			sh_main.Pipeline( R"(C:\Projects\VkFrameGraph\samples\framegraph\Shadertoy\st_shaders\SirenianDawn.glsl)" );
			sh_main.InChannel( R"(C:\Projects\VkFrameGraph\samples\framegraph\Shadertoy\data\GreyNoiseMedium.png)", 0 );
		...
		{
			ShaderDescr	sh_bufA;
			sh_bufA.Pipeline( R"(C:\Projects\VkFrameGraph\samples\framegraph\Shadertoy\st_shaders\SirenianDawn_1.glsl)" );
			sh_bufA.InChannel( R"(C:\Projects\VkFrameGraph\samples\framegraph\Shadertoy\data\GreyNoiseMedium.png)", 0 );
			sh_bufA.InChannel( "bufA", 1 );
			CHECK( _AddShader( "bufA", std::move(sh_bufA) ));

			ShaderDescr	sh_main;
			sh_main.Pipeline( R"(C:\Projects\VkFrameGraph\samples\framegraph\Shadertoy\st_shaders\SirenianDawn_2.glsl)" );
			sh_main.InChannel( "bufA", 0 );
			CHECK( _AddShader( "main", std::move(sh_main) ));
		});*/
	}
