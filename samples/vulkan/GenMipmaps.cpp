...
=================================================
*/
void GenMipmapsApp::GenMipmapsOnTransferCommands (VkCommandBuffer cmd, OUT VkImageLayout &)
{
	VkImageMemoryBarrier	barrier = {};
	barrier.sType				= VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER;
	barrier.srcAccessMask		= 0;
...
=================================================
*/
void GenMipmapsApp::GenMipmapsOnComputeShader (VkCommandBuffer cmd, OUT VkImageLayout &)
{
	VkImageMemoryBarrier	barrier = {};
	barrier.sType				= VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER;
	barrier.srcAccessMask		= 0;
...
void GenMipmapsApp::GenerateMipmaps (uint mode)
{
	...
	// generate procedural image
	{
		...
		vkCmdPipelineBarrier( cmd, VK_PIPELINE_STAGE_TRANSFER_BIT | VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT, VK_PIPELINE_STAGE_ALL_COMMANDS_BIT, 0,
							  0, null, 0, null, 1, &barrier );
	}

	vkCmdWriteTimestamp( cmd, VK_PIPELINE_STAGE_ALL_COMMANDS_BIT, queryPool, 0 );

	VkImageLayout	curr_layout = VK_IMAGE_LAYOUT_GENERAL;
