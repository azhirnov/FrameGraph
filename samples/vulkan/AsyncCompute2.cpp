...
=================================================
*/
void AsyncComputeApp2::OnKey (StringView key, EKeyAction action)
{
...
=================================================
*/
void AsyncComputeApp2::OnResize (const uint2 &size)
{
...
=================================================
*/
bool AsyncComputeApp2::Initialize ()
{
...
void AsyncComputeApp2::GenComputeCommands1 (uint frameId)
{
	...
	// submit compute commands
	{
		...
		VK_CALL( vkQueueSubmit( vulkan.GetVkQuues()[1].id, 1, &submit_info, VK_NULL_HANDLE ));
	}
}
...
void AsyncComputeApp2::Present1 (uint frameId)
{
	...
	// submit graphics commands
	{
		...
		VK_CALL( vkQueueSubmit( vulkan.GetVkQuues()[0].id, 1, &submit_info, fences[frameId] ));
	}

	// present
	VkResult	err = swapchain->Present( vulkan.GetVkQuues()[0].id, {semaphores[3]} );
	switch ( err ) {
		case VK_SUCCESS :
			break;
...
=================================================
*/
bool AsyncComputeApp2::CreateCommandBuffers ()
{
...
=================================================
*/
bool AsyncComputeApp2::CreateSyncObjects ()
{
	VkDevice	dev = vulkan.GetVkDevice();
...
=================================================
*/
bool AsyncComputeApp2::CreateRenderPass ()
{
	// setup attachment
...
=================================================
*/
bool AsyncComputeApp2::CreateSampler ()
{
...
=================================================
*/
bool AsyncComputeApp2::CreateDescriptorSet ()
{
...
=================================================
*/
bool AsyncComputeApp2::CreateGraphicsPipeline ()
{
