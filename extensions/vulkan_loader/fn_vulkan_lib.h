	...
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkEnumerateInstanceLayerProperties (uint32_t * , VkLayerProperties * )			{  FG_LOGI( "used dummy function 'vkEnumerateInstanceLayerProperties'" );  return VK_RESULT_MAX_ENUM;  }
	...
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkCreateInstance (const VkInstanceCreateInfo * , const VkAllocationCallbacks * , VkInstance * )			{  FG_LOGI( "used dummy function 'vkCreateInstance'" );  return VK_RESULT_MAX_ENUM;  }
	...
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkEnumerateInstanceVersion (uint32_t * )			{  FG_LOGI( "used dummy function 'vkEnumerateInstanceVersion'" );  return VK_RESULT_MAX_ENUM;  }
	VKAPI_ATTR VkResult VKAPI_CALL Dummy_vkEnumerateInstanceExtensionProperties (const char * , uint32_t * , VkExtensionProperties * )			{  FG_LOGI( "used dummy function 'vkEnumerateInstanceExtensionProperties'" );  return VK_RESULT_MAX_ENUM;  }
