...
#	define DXGI_FG_PAIR( _visit_ ) \
		...
		_visit_( DXGI_FORMAT_BC1_UNORM_SRGB,			EPixelFormat::BC1_sRGB8_UNorm ) \
		_visit_( DXGI_FORMAT_BC2_UNORM,					EPixelFormat::BC2_RGBA8_UNorm ) \
		_visit_( DXGI_FORMAT_BC2_UNORM_SRGB,			EPixelFormat::BC2_RGBA8_UNorm ) \
		_visit_( DXGI_FORMAT_BC3_UNORM,					EPixelFormat::BC3_RGBA8_UNorm ) \
		_visit_( DXGI_FORMAT_BC3_UNORM_SRGB,			EPixelFormat::BC3_sRGB ) \
...
=================================================
*/
	ND_ constexpr uint  MakeFourCC (uint8_t a, uint8_t b, uint8_t c, uint8_t d)
	{
...
=================================================
*/
	ND_ EPixelFormat  DDSFormatToPixelFormat (DXGI_FORMAT fmt)
	{
		switch ( fmt )
		{
...
=================================================
*/
	bool  LoadDX10Image (IntermImagePtr &image, const DDS_HEADER &header, const DDS_HEADER_DXT10 &headerDX10, FileRStream &file)
	{
...
=================================================
*/
	bool  LoadDDSImage (IntermImagePtr &image, const DDS_HEADER &header, FileRStream &file)
	{
		return false;
	}
}
