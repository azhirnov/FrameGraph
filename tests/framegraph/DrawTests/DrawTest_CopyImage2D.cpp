...
namespace FG
{
	...
	bool FGApp::_DrawTest_CopyImage2D ()
	{
		...
		ImagePtr		src_image		= _CreateImage2D( src_dim, EPixelFormat::RGBA8_UNorm, "SrcImage" );
		ImagePtr		dst_image		= _CreateImage2D( dst_dim, EPixelFormat::RGBA8_UNorm, "DstImage" );
