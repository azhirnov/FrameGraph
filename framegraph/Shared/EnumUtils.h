...
*/
	struct PixelFormatInfo
	{
		...
		constexpr PixelFormatInfo (EPixelFormat fmt, uint bpp, uint channels, EType type, EImageAspect aspect = EImageAspect::Color) :
			format{fmt}, bitsPerBlock{bpp}, aspectMask{aspect}, valueType{type}, channels{channels} {}

		constexpr PixelFormatInfo (EPixelFormat fmt, uint bpp, const uint2 &size, uint channels, EType type, EImageAspect aspect = EImageAspect::Color) :
			format{fmt}, bitsPerBlock{bpp}, aspectMask{aspect}, valueType{type}, blockSize{size}, channels{channels} {}

		constexpr PixelFormatInfo (EPixelFormat fmt, uint2 depthStencilBPP, EType type = EType::DepthStencil, EImageAspect aspect = EImageAspect::DepthStencil) :
	...
	ND_ inline PixelFormatInfo const&  EPixelFormat_GetInfo (EPixelFormat value)
	{
		...
		static const PixelFormatInfo	fmt_infos[] = {
			...
			{ EPixelFormat::BC1_sRGB8,				64,		{4,4},	3,	EType::UNorm | EType::sRGB },
			{ EPixelFormat::BC1_RGB8_A1_UNorm,		64,		{4,4},	4,	EType::UNorm },
			{ EPixelFormat::BC1_sRGB8_A1,			64,		{4,4},	4,	EType::UNorm | EType::sRGB },
			{ EPixelFormat::BC2_RGBA8_UNorm,		128,	{4,4},	4,	EType::UNorm },
			{ EPixelFormat::BC2_sRGB8_A8,			128,	{4,4},	4,	EType::UNorm | EType::sRGB },
			{ EPixelFormat::BC3_RGBA8_UNorm,		128,	{4,4},	4,	EType::UNorm },
			{ EPixelFormat::BC3_sRGB8,				128,	{4,4},	3,	EType::UNorm | EType::sRGB },
