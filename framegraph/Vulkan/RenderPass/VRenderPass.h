...
namespace FG
{
	...
	class VRenderPass final : public std::enable_shared_from_this<VRenderPass>
	{
	...
	// methods
	private:
		bool _Setup (ArrayView<VLogicalRenderPass*> logicalPasses, ArrayView<GraphicsPipelineDesc::FragmentOutput> fragOutput);
	...
	public:
		...
		ND_ VkRenderPass					GetRenderPassID ()	const	{ return _renderPass; }
