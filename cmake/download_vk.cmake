...
if (FALSE)
	if (${CMAKE_SYSTEM_NAME} STREQUAL "Linux")
		set( FG_GLOBAL_DEFINITIONS "${FG_GLOBAL_DEFINITIONS}" "-DVK_USE_PLATFORM_XCB_KHR=1" "-DVK_USE_PLATFORM_XLIB_KHR=1" )	# TODO

	elseif (${CMAKE_SYSTEM_NAME} STREQUAL "Android")
		set( FG_GLOBAL_DEFINITIONS "${FG_GLOBAL_DEFINITIONS}" "-DVK_USE_PLATFORM_ANDROID_KHR=1" )

	elseif (${CMAKE_SYSTEM_NAME} STREQUAL "Darwin")
		set( FG_GLOBAL_DEFINITIONS "${FG_GLOBAL_DEFINITIONS}" "-DVK_USE_PLATFORM_MACOS_MVK=1" )

	elseif (${CMAKE_SYSTEM_NAME} STREQUAL "iOS")
		set( FG_GLOBAL_DEFINITIONS "${FG_GLOBAL_DEFINITIONS}" "-DVK_USE_PLATFORM_IOS_MVK=1" )

	elseif (WIN32 OR ${CMAKE_SYSTEM_NAME} STREQUAL "Windows")
		set( FG_GLOBAL_DEFINITIONS "${FG_GLOBAL_DEFINITIONS}" "-DVK_USE_PLATFORM_WIN32_KHR=1" )
		set( FG_GLOBAL_DEFINITIONS "${FG_GLOBAL_DEFINITIONS}" "-DNOMINMAX" "-DNOMCX" "-DNOIME" "-DNOSERVICE" "-DWIN32_LEAN_AND_MEAN" )
	endif ()
endif ()
